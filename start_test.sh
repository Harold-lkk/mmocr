...
PYTHONPATH='.':${PYTHONPATH} PARROTS_EXEC_MODE=SYNC PARROTS_BT_DEPTH=15 PARROTS_ALIGN_TORCH=1 sh tools/dist_test.sh configs/textdet/dbnet/__base__/dbnet_r50_fpnc_textocr.py checkpoints/checkpoints_dbnet-2/epoch_9.pth 1 --eval hmean-iou
